...
it('map([1, 2]), (item) => item) should return return [1, 2]', () => {
    expect(map([1, 2], (item) => item)).to.be.deep.equal([1, 2]);
});

it('map([3, 4]), (item) => item) should return return [3, 4]', () => {
    expect(map([3, 4], (item) => item)).to.be.deep.equal([3, 4]);
});

it('map([1, 2]), (item) => item + 1) should return return [2, 3]', () => {
    expect(map([1, 2], (item) => item + 1)).to.be.deep.equal([2, 3]);
});

it('map([4, 6]), (item) => item + 1) should return return [5, 7]', () => {
...
it('map([1, 2], (item) => item + item should return [2, 4]', () => {
    expect(map([1, 2], (item) => item + item)).to.be.deep.equal([2, 4])
});
